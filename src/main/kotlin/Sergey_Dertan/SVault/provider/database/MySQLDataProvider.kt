...
import Sergey_Dertan.SVault.settings.MySQLSettings
import com.mysql.cj.jdbc.Driver
import org.datanucleus.metadata.PersistenceUnitMetaData

class MySQLDataProvider(settings: MySQLSettings) : DatabaseDataProvider() {
    ...
    override fun getType(): DataProvider.Type = DataProvider.Type.MYSQL
}
